...
Normalization: All values ​​are expressed in kWh/kWp (energy generated per kW of installed panel), allowing for fair comparison between systems of different capacities.
...
Dominance Heatmap: Tindo dominates all 12 months of the year (green), Kyocera never wins a month.
